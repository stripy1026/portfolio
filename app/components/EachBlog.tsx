  ...
  return (
    ...
    >
      <Link href={href} target="_blank" rel="noreferrer">
        ...
        <h3 className="mt-2 font-bold text-lg sm:text-2xl text-rose-700">
          {title}
        </h3>
        <p className="text-xs sm:text-sm sm:my-1 text-gray-300">
          {createdDate}
        </p>
        <p className="text-sm my-2 sm:my-4 text-gray-300">{description}</p>
      </Link>
    </div>
  );
};
